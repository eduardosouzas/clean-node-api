...
describe('SignUp Controller', () => {
  ...
  test('should return 400 if no passwod is provided ', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('should return 400 if an invalid email is invalid ', async () => {
  ...
  test('should return 200 if valid data is valid ', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'valid_name',
